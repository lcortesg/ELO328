...
Se debe instalar la versión oficial de python (recomendamos la versión 3.8) encontrada en el siguiente [link](https://www.python.org/downloads/), es necesario que python se instale mediante esta vía, ya que las versiones suministradas por gestores de paketes tales como brew y cask carecen del módulo Tkinter.
